...
DEFAULT_REGION = ""
DEFAULT_AGENT_URL = ""
DEFAULT_ADDON_AGENT_URL = "http://127.0.0.1:8099"
DEFAULT_AGENT_MODE = "fallback"
DEFAULT_AGENT_TOKEN = ""

AGENT_MODE_FALLBACK = "fallback"
AGENT_MODE_LOCAL_RUNNER = "local_runner"
AGENT_MODE_ADDON = "addon"
AGENT_MODE_EXTERNAL_AGENT = "external_agent"
AGENT_MODES = [
    AGENT_MODE_FALLBACK,
